...
- (void)showAlert {
        ...
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Missing Field Required"
                                                                                   message:@"One of your required fields is not complete. Please enter your information in the required field"
